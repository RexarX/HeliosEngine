...
namespace VoxelEngine
{
	...
	{
	public:
		OpenGLTexture(const std::string& name, const TextureSpecification& specification);
		OpenGLTexture(const std::string& name, const std::string& path);
		OpenGLTexture(const std::string& name, const std::vector<std::string>& paths);
