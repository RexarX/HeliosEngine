 ...
 * @details Requires nested types rep, period, duration and time_point, and a
 * static now() function.
 */
template <typename T>
...
/**
 * @brief Helper alias to normalize a duration to its canonical
 * std::chrono::duration form.
 */
...
public:
   ...
   * `details::DurationTrait`. Defaults to `Clock::duration`.
  ...
  template <utils::ArithmeticTrait Type = typename Duration::rep,
            details::DurationTrait Units = Duration>
