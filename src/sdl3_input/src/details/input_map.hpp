...
[[nodiscard]] constexpr auto MouseButtonFromSdl(Uint8 button) noexcept
  ...
  switch (button) {
    ...
    case 6:
      return helios::input::MouseButton::kExtra3;
    case 7:
      return helios::input::MouseButton::kExtra4;
    case 8:
      return helios::input::MouseButton::kExtra5;
    default:
      return std::nullopt;
  }
}
...
/**
 * @brief Maps an SDL touch device type to `helios::input::TouchDeviceType`.
 * @param type SDL touch device type
 * @return Matching device type (`kUnknown` when invalid)
 */
[[nodiscard]] constexpr helios::input::TouchDeviceType TouchDeviceTypeFromSdl(
    SDL_TouchDeviceType type) noexcept {
  switch (type) {
    case SDL_TOUCH_DEVICE_DIRECT:
      return helios::input::TouchDeviceType::kDirect;
    case SDL_TOUCH_DEVICE_INDIRECT_ABSOLUTE:
      return helios::input::TouchDeviceType::kIndirectAbsolute;
    case SDL_TOUCH_DEVICE_INDIRECT_RELATIVE:
      return helios::input::TouchDeviceType::kIndirectRelative;
    case SDL_TOUCH_DEVICE_INVALID:
    default:
      return helios::input::TouchDeviceType::kUnknown;
  }
}

/**
 * @brief Maps an SDL sensor type to `helios::input::SensorType`.
 * @param type SDL sensor type
 * @return Matching sensor type (`kUnknown` when invalid)
 */
[[nodiscard]] constexpr helios::input::SensorType SensorTypeFromSdl(
    SDL_SensorType type) noexcept {
  switch (type) {
    case SDL_SENSOR_ACCEL:
      return helios::input::SensorType::kAccel;
    case SDL_SENSOR_GYRO:
      return helios::input::SensorType::kGyro;
    case SDL_SENSOR_ACCEL_L:
      return helios::input::SensorType::kAccelLeft;
    case SDL_SENSOR_GYRO_L:
      return helios::input::SensorType::kGyroLeft;
    case SDL_SENSOR_ACCEL_R:
      return helios::input::SensorType::kAccelRight;
    case SDL_SENSOR_GYRO_R:
      return helios::input::SensorType::kGyroRight;
    case SDL_SENSOR_INVALID:
    case SDL_SENSOR_UNKNOWN:
    default:
      return helios::input::SensorType::kUnknown;
  }
}
