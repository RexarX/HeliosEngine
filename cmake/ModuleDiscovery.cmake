...
function(helios_discover_modules)
  ...
  if(HELIOS_BUILD_ALL_MODULES)
    message(STATUS "--- HELIOS_BUILD_ALL_MODULES: force-enabling modules (Pass 1B) ---")
    set(_claimed_impl_tags)
    ...
    foreach(_module IN LISTS _discovered)
      ...
      if(_collides)
        message(STATUS "  Skipping ${_module} (IMPLEMENTS collision with an enabled module)")
        continue()
      endif()
