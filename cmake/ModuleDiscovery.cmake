...
function(_helios_discover_module_at_path MODULE_PATH)
  ...
  if(NOT _module_name IN_LIST _discovered)
    set_property(GLOBAL APPEND PROPERTY HELIOS_DISCOVERED_MODULES ${_module_name})
...
function(helios_discover_modules)
  ...
  if(HELIOS_BUILD_ALL_MODULES)
    ...
    foreach(_module ${_discovered})
      ...
      set(HELIOS_BUILD_${_upper}_MODULE ON CACHE BOOL "Build the ${_module} module" FORCE)
    endforeach()
    message(STATUS "")
  endif()
endfunction()
