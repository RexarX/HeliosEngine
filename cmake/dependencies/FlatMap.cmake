...
if(HELIOS_HAS_STL_FLAT_MAP)
  ...
  if(NOT TARGET helios::lib::stl_flat_map)
    add_library(helios::lib::stl_flat_map INTERFACE IMPORTED GLOBAL)
    target_compile_definitions(helios::lib::stl_flat_map INTERFACE HELIOS_USE_STL_FLAT_MAP)
  endif()

  if(NOT TARGET helios::lib::flat_map)
    add_library(helios::lib::flat_map INTERFACE IMPORTED GLOBAL)
    target_link_libraries(helios::lib::flat_map INTERFACE helios::lib::stl_flat_map)
  endif()
  ...
  if(TARGET helios::lib::boost::container OR TARGET Boost::boost OR TARGET helios::lib::boost::boost)
    if(NOT TARGET helios::lib::flat_map)
      add_library(helios::lib::flat_map INTERFACE IMPORTED GLOBAL)
      if(TARGET helios::lib::boost::container)
        target_link_libraries(helios::lib::flat_map INTERFACE helios::lib::boost::container)
      elseif(TARGET helios::lib::boost::boost)
        target_link_libraries(helios::lib::flat_map INTERFACE helios::lib::boost::boost)
      elseif(TARGET Boost::container)
        target_link_libraries(helios::lib::flat_map INTERFACE Boost::container)
      elseif(TARGET Boost::boost)
        target_link_libraries(helios::lib::flat_map INTERFACE Boost::boost)
      endif()
    endif()
