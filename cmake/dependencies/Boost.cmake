...
if(HELIOS_HAS_STL_STACKTRACE)
  ...
  if(NOT TARGET helios::lib::stl_stacktrace)
    add_library(helios::lib::stl_stacktrace INTERFACE IMPORTED GLOBAL)
    target_compile_definitions(helios::lib::stl_stacktrace INTERFACE HELIOS_USE_STL_STACKTRACE)
    if(_stl_stacktrace_link_libs)
      target_link_libraries(helios::lib::stl_stacktrace INTERFACE ${_stl_stacktrace_link_libs})
    endif()
  endif()

  if(NOT TARGET helios::lib::boost::stacktrace)
    add_library(helios::lib::boost::stacktrace INTERFACE IMPORTED GLOBAL)
    target_link_libraries(helios::lib::boost::stacktrace INTERFACE helios::lib::stl_stacktrace)
  endif()
else()
...
if(Boost_FOUND)
  ...
  if(NOT TARGET helios::lib::boost::boost)
    add_library(helios::lib::boost::boost INTERFACE IMPORTED GLOBAL)
    _helios_link_boost_interface(helios::lib::boost::boost)
  endif()
  ...
  if(NOT HELIOS_USE_STL_STACKTRACE)
    if(NOT TARGET helios::lib::boost::stacktrace)
      ...
      if(TARGET Boost::stacktrace)
        target_link_libraries(helios::lib::boost::stacktrace INTERFACE Boost::stacktrace)
      else()
        _helios_link_boost_interface(helios::lib::boost::stacktrace)
      endif()
    endif()
  endif()

  if(NOT TARGET helios::lib::boost::unordered)
    add_library(helios::lib::boost::unordered INTERFACE IMPORTED GLOBAL)
    _helios_link_boost_interface(helios::lib::boost::unordered)
  endif()

  if(NOT TARGET helios::lib::boost::container)
    add_library(helios::lib::boost::container INTERFACE IMPORTED GLOBAL)
    if(TARGET Boost::container)
      target_link_libraries(helios::lib::boost::container INTERFACE Boost::container)
    else()
      _helios_link_boost_interface(helios::lib::boost::container)
    endif()
  endif()
  ...
  if(HELIOS_DOWNLOAD_PACKAGES)
    ...
    if(Boost_ADDED OR TARGET Boost::boost)
      if(NOT TARGET helios::lib::boost::boost)
        add_library(helios::lib::boost::boost INTERFACE IMPORTED GLOBAL)
        if(TARGET Boost::boost)
          target_link_libraries(helios::lib::boost::boost INTERFACE Boost::boost)
        endif()
      endif()
      ...
      if(NOT HELIOS_USE_STL_STACKTRACE)
        ...
        if(TARGET Boost::stacktrace)
          ...
          target_link_libraries(helios::lib::boost::stacktrace INTERFACE helios::lib::boost::boost)
        endif()
      endif()

      if(NOT TARGET helios::lib::boost::unordered)
        add_library(helios::lib::boost::unordered INTERFACE IMPORTED GLOBAL)
        target_link_libraries(helios::lib::boost::unordered INTERFACE helios::lib::boost::boost)
        if(Boost_SOURCE_DIR AND EXISTS "${Boost_SOURCE_DIR}/libs/unordered/include")
          target_include_directories(helios::lib::boost::unordered SYSTEM INTERFACE
...
if(NOT TARGET helios::lib::boost)
  add_library(_helios_boost_all INTERFACE)
  if(TARGET helios::lib::boost::boost)
    target_link_libraries(_helios_boost_all INTERFACE helios::lib::boost::boost)
  endif()
  if(TARGET helios::lib::boost::unordered)
    target_link_libraries(_helios_boost_all INTERFACE helios::lib::boost::unordered)
  endif()
  if(TARGET helios::lib::boost::stacktrace)
    target_link_libraries(_helios_boost_all INTERFACE helios::lib::boost::stacktrace)
  endif()
